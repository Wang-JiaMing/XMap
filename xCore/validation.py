        ...
        if imageBaseInfo[1] == sourceBaseInfo[1] and imageBaseInfo[2] == sourceBaseInfo[2] and imageBaseInfo[4] == \
            ...
            if 'xUniqueKey' in imageBaseInfo[3]:
                ...
                if utils.valiXUniqueKey(xUniqueKey):
                    ...
                    # 直接对比标签和属性是否存在
                    if imageBaseInfo[3][xUniqueKey] == sourceBaseInfo[3][xUniqueKey] and (
                            imageBaseInfo[3]['xValue'] != 'text' and valiParams(
                        utils.getxValueKey(imageBaseInfo[3]['xValue']), sourceBaseInfo[3])):
                        existIndex = existIndex + 1
            else:
                existIndex = existIndex + 1
    valiStatus = True
